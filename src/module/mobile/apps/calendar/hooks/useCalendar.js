...
const useCalendar = () => {
  ...
  const [events, setEvents] = useState(() => {
    ...
    return [
      {
        id: "1",
        title: "Portfolio + SEO check",
        date: todayStr,
        start: "09:00",
        end: "10:30",
        category: "birthdays",
        desc: "Review nishantx.in SEO, sitemap, and dock polish.",
      },
      {
        id: "2",
        title: "OSS PR follow-ups",
        date: todayStr,
        start: "14:00",
        end: "15:30",
        category: "work",
        desc: "Hardhat / Hyperlane / viem contribution follow-ups.",
      },
      {
        id: "3",
        title: "Krydo + BlockForge demos",
        date: tomorrowStr,
        start: "12:30",
        end: "13:30",
        category: "personal",
        desc: "Warm Render demos and verify live links.",
      },
      {
        id: "4",
        title: "TrustMesh + CivicSense QA",
        date: dayAfterStr,
        start: "10:00",
        end: "11:30",
        category: "work",
        desc: "Smoke-test Stellar and civic reporting flows.",
      },
    ];
  });
