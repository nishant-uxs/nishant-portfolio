...
const useCalendar = () => {
  ...
  const [events, setEvents] = useState(() => {
    ...
    return [
      ...
      {
        id: "2",
        title: "BlockForge / NetCrypt Prep",
        date: "2026-05-26",
        start: "14:00",
        end: "15:30",
        category: "work",
        desc: "Polish BlockForge demo and NetCrypt 2026 paper notes.",
      },
      {
        id: "3",
        title: "OSS PR Review Window",
        date: "2026-05-27",
        start: "12:30",
        end: "13:30",
        category: "personal",
        desc: "Review Hardhat / Hyperlane / viem contribution threads.",
      },
      {
        id: "4",
        title: "Krydo Test Suite Run",
        date: "2026-05-29",
        start: "09:00",
        end: "10:30",
        category: "work",
      ...
      {
        id: "5",
        title: "Bennett Semester Break",
        date: "2026-05-25",
        start: "00:00",
        end: "23:59",
        category: "holidays",
        desc: "University break — catch up on portfolio and OSS.",
      },
    ];
  });
