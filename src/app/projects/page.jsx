...
export const metadata = {
  ...
  description:
    "Projects by Nishant Agarwal: Krydo (Stellar Soroban privacy identity, krydo.in), BlockForge (NetCrypt 2026), CivicSense, and TrustMesh — backend and blockchain systems.",
  keywords: [
  ...
  return (
    <SeoDocShell title="Projects — Nishant Agarwal">
      <article>
        ...
        <p>
          These are featured production and research projects by Nishant Agarwal spanning Stellar
          Soroban privacy identity, decentralized assessment, civic reporting, and on-chain
          reputation.
        </p>
        ...
        {featuredProjects.map((project) => (
          ...
          >
            ...
            {project.stack ? (
              <p className="seo-doc-muted" style={{ marginTop: "0.25rem", fontSize: "0.9rem" }}>
                {project.stack}
